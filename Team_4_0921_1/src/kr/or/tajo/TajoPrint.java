...
public class TajoPrint {
	...
	public static int userMenu() {
		...
		System.out.println("원하시는 메뉴를 선택하세요");
		System.out.println("***************************************");
		System.out.println("1. 대여하기 | 2. 반납하기 | 3. 회원정보 수정 | 4. 회원탈퇴 | 5.종료");
		...
		case 2:
			for (Object o : productValueList) {
				if ((Product) o instanceof ChargeAble) {
					String str = (o instanceof ProductOil) ? ((ProductOil)o).isCharged() +"" : ((ProductElectric)o).isCharged() + "";
					System.out.println(((Product) o).toString() + "[charged=" + str + "]");
				}
			}
