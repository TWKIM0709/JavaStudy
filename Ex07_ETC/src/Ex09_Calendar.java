...
public class Ex09_Calendar {
	...
	public static void main(String[] args) {
		...
		//당신이 필요한 형식을 추출해서 조립해라
		
		System.out.println("년도 :"  + cal.get(Calendar.YEAR));
		System.out.println("월 :"  + (cal.get(Calendar.MONTH)+1));	//월을 0~11로 표시
		System.out.println("일 :"  + cal.get(Calendar.DATE));

		System.out.println("이 달의 몇쨰주 : "  + cal.get(Calendar.WEEK_OF_MONTH));
		...
		//ex) 학사관리시스템 웹
		//페이지 본수 : 200page
		//150page에는 날짜정보가 들어가야 된다. 각 페이지 하단에 출력 ( 2022년9월14일 )
		//A 친구 페이지에 박음 ... cal.get(Calendar.YEAR) + cal.get(Calendar.MONTH) + cal.get(Calendar.DATE)
		//갑자기 해외 수출... 날짜를 2022-09-14 형태로...
